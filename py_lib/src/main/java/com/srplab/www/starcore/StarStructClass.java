...
public class StarStructClass {
    private StarCoreFactory StarCore;
    private long m_Handle;

    private StarStructClass(StarCoreFactory var1, Object[] var2) {
        this.StarCore = var1;
        this.StarCore._InitObject(this, var2);
    }

    public StarStructClass(StarStructClass var1) {
        this.StarCore = var1.StarCore;
        this.StarCore._WrapObject(this, var1);
    }

    public StarStructClass() {
    }
    ...
    public StarStructClass _Assign(StarStructClass var1) {
